...
/// <summary>
/// Currency exchange-rate client backed by exchangerate-api.com (USD-based; 1,500 free calls/month).
/// Active when "CurrencyExchange:Provider" is <see cref="CurrencyExchangeClientType.ExchangeRateApiCom"/>.
/// </summary>
public class ExchangeRateApiComClient(
    IHttpClientFactory httpClientFactory,
    IConfiguration configuration,
    IHostEnvironment environment,
    ILogger<ExchangeRateApiComClient> logger) : ICurrencyExchangeRateClient
{
